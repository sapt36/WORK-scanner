...
int main(int argc, char *argv[]){
    ...
    FILE *In;
    FILE *Out;
    In = fopen("scanner.c","r");
    Out = fopen("scannerOut.txt","w");
    if(In == NULL){
        printf("Fail to read file!\n"); 
        return 0;
    }
    while(fgets(stringIn , 255, In) != NULL){
        int x = 0;
        int y = 0;
        while(stringIn[x] != '\n'){
            ...
            switch(stringIn[x]){
                ...
                case 'r': case 'x': case 'y': case 'Q': case 'R': case 'T': case 'U': case 'V': case 'X': case 'F':
                case 'z': case 'A': case 'B': case 'G': case 'H': case 'J': case 'K': case 'L': case 'M': case 'N': 
				case 'O': case 'P': case 'o': case 'p': case 'q': case 'I': case 'C':
                	stringArray[y]=stringIn[x];
                    x++;
                    y++;
